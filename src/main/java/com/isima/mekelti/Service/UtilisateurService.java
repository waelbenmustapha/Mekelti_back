...
private final BCryptPasswordEncoder bCryptPasswordEncoder;
  ...
  public String signup(Utilisateur utilisateur) throws UnsupportedEncodingException, MessagingException {
  boolean exists =  utilisateurRepository.findByEmail(utilisateur.getEmail()).isPresent();
   if(exists){
     throw new IllegalStateException("email already exists");
   }
  String encodedPassword =  bCryptPasswordEncoder.encode(utilisateur.getMotDePasse());
    String generatedverifcationcode = RandomString.make(64);
    utilisateur.setVerificationCode(generatedverifcationcode);
